...
public class ImageModel extends Observable implements Transferable {
    ...
    private String name = Messages.getString("ImageModel.Background"); //$NON-NLS-1$
    ...
    public DataFlavor[] getTransferDataFlavors() {
        DataFlavor df = new DataFlavor(ImageModel.class, "imageModel"); //$NON-NLS-1$
        return new DataFlavor[]{df};
    }

    @Override
    public boolean isDataFlavorSupported(DataFlavor flavor) {
        return flavor.equals(new DataFlavor(ImageModel.class, "imageModel")); //$NON-NLS-1$
    }

    @Override
    public Object getTransferData(DataFlavor flavor) throws UnsupportedFlavorException, IOException {
        if (flavor.equals(new DataFlavor(ImageModel.class, "imageModel"))) { //$NON-NLS-1$
            return this;
        } else {
